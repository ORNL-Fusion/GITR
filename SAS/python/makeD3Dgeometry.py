...
def makeGeom(inFile='d3drzZ.csv',filename="gitrD3DGeometry2DWringsPy.cfg",plot=1):
    ...
    reverseDir =[0,1,2,3,4,5,6,7,8,11,19,21,25,37,38,39,47,48,49,50,51,52,54]
    inDir[reverseDir] = -1;
...
if __name__ == "__main__":
    makeGeom(inFile='SAS.csv',filename="gitrD3DGeometrySASPy1.cfg",plot=1)
    removeQuotes(infile="gitrD3DGeometrySASPy1.cfg",outfile="gitrD3DGeometrySASPy.cfg")
