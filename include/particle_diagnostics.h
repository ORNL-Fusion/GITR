...
struct particle_diagnostics {
  ...
  particle_diagnostics(Flags *_flags, Particles *_particlesPointer, Boundary *_boundaryVector, bool _time_logarithmic,
                       ...
                       int _n_bins_time, gitr_precision *_particle_time_histogram, gitr_precision _bin_edge_0_angle, 
                       gitr_precision _bin_edge_1_angle, gitr_precision _bin_edge_dtheta, int _n_bins_angle, 
