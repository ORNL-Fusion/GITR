...
void getBoundaryNormal(Boundary* boundaryVector,int wallIndex,gitr_precision surfaceNormalVector[],gitr_precision x,gitr_precision y){
  #if USE3DTETGEOM > 0
           gitr_precision norm_normal = boundaryVector[wallIndex].plane_norm; 
            ...
            gitr_precision norm_normal = 0.0f;
            ...
            gitr_precision Sr = surfaceNormalVector[0];
