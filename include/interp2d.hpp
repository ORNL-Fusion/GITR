...
gitr_precision* gridx,gitr_precision* gridz,gitr_precision* datar, gitr_precision* dataz, gitr_precision* datat, int cylsymm );
CUDA_CALLABLE_MEMBER
void interpFieldAlignedVector ( gitr_precision* field, gitr_precision x, gitr_precision y, gitr_precision z,int nx, int nz,
        ...
        int nxB, int nzB, gitr_precision* gridxB,gitr_precision* gridzB,gitr_precision* datarB,gitr_precision* datazB, gitr_precision* datatB, int cylsymm );
CUDA_CALLABLE_MEMBER
