...
It tests ionization and recombination implementation for the multi-ion capability of GITR.
...
import libconf
import io
from periodictable import tungsten, carbon, oxygen, nitrogen
...
#materials = [nitrogen, carbon, oxygen]
materials = [oxygen, tungsten]
numberParticlesPerSpecies = [2000,2000]
...
base_path = join(HOME, "build/new")  # Path to the GITR executable
run_gitr(base_path)
