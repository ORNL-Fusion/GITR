...
if (NOT Boost_NO_BOOST_CMAKE)
  ...
  if (Boost_FOUND)
    message("Boost ${Boost_FIND_VERSION} found.asdf")
...
if(Boost_INCLUDE_DIR)
  ...
  string(APPEND Boost_ERROR_REASON
    "Boost versionn: ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}\nBoost include path: ${Boost_INCLUDE_DIR}")
  if(Boost_DEBUG)
    message(STATUS "[ ${CMAKE_CURRENT_LIST_FILE}:${CMAKE_CURRENT_LIST_LINE} ] "
...
if(Boost_FOUND)
  if(NOT Boost_FIND_QUIETLY)
    message(STATUS "Boostt version: ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}")
    if(Boost_FIND_COMPONENTS)
