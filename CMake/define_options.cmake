...
set( GITR_USE_THERMAL_FORCE 0 STRING "${description}" )
set( GITR_USE_SURFACE_MODEL 0 STRING "${description}" ) 
set( GITR_USE_SHEATH_EFIELD 0 STRING "${description}" )
set( GITR_BIASED_SURFACE 0 STRING "${description}" )
set( GITR_USE_SURFACE_POTENTIAL 0 STRING "${description}" )
set( GITR_USE_PRE_SHEATH_EFIELD 0 STRING "${description}" )
set( GITR_BFIELD_INTERP 0 STRING "${description}" )
set( GITR_LC_INTERP 0 STRING "${description}" )
set( GITR_GENERATE_LC 0 STRING "${description}" )
set( GITR_EFIELD_INTERP 0 STRING "${description}" )
set( GITR_PRE_SHEATH_INTERP 0 STRING "${description}" )
set( GITR_DENSITY_INTERP 0 STRING "${description}" )
set( GITR_TEMP_INTERP 0 STRING "${description}" )
set( GITR_FLOWV_INTERP 2 STRING "${description}" )
set( GITR_GRADT_INTERP 0 STRING "${description}" )
set( GITR_ODE_INT 0 STRING "${description}" )
set( GITR_FIXED_SEEDS 0 STRING "${description}" )
set( GITR_PARTICLE_SEEDS 1 STRING "${description}" )
set( GITR_GEOM_TRACE 0 STRING "${description}" )
set( GITR_GEOM_HASH 0 STRING "${description}" )
set( GITR_GEOM_HASH_SHEATH 0 STRING "${description}" )
set( GITR_PARTICLE_TRACKS 0 STRING "${description}" )
set( GITR_PARTICLE_SOURCE 0 STRING "${description}" )
set( GITR_PARTICLE_SOURCE_SPACE 0 STRING "${description}" )
set( GITR_PARTICLE_SOURCE_ENERGY 0 STRING "${description}" )
set( GITR_PARTICLE_SOURCE_ANGLE 0 STRING "${description}" )
set( GITR_PARTICLE_SOURCE_FILE 1 STRING "${description}" )
set( GITR_SPECTROSCOPY 0 STRING "${description}" )
set( GITR_USE_3DTET_GEOM 0 STRING "${description}" )
set( GITR_USE_CYLSYMM 0 STRING "${description}" )
set( GITR_USE_FIELD_ALIGNED_VALUES 0 STRING "${description}" )
set( GITR_FLUX_EA 1 STRING "${description}" )
set( GITR_FORCE_EVAL 0 STRING "${description}" )
set( GITR_USE_SORT 0 STRING "${description}" )
set( GITR_CHECK_COMPATIBILITY 1 STRING "${description}" )
