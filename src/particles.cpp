#include "Particles.h"
  ...
  void Particles::setParticle(int indx, gitr_precision x, gitr_precision y, gitr_precision z,
  ...
  CUDA_CALLABLE_MEMBER
  void Particles::setParticleV(int indx, gitr_precision x, gitr_precision y, gitr_precision z,
  ...
  CUDA_CALLABLE_MEMBER
  void Particles::swapP(int indx, int n)
  {
  ...
  CUDA_CALLABLE_MEMBER
  Particles::Particles(std::size_t nP,std::size_t nStreams,libconfig::Config &cfg ) :
