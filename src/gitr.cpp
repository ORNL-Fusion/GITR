...
if( flowv_interp == 1 )
{
  ...
  interp2dVector(&gradTi[0], 1.45, 0.0, -1.2, nR_gradT, nZ_gradT,
                 ...
                 gradTiZ.data(), gradTiY.data(), use_cylsymm );
