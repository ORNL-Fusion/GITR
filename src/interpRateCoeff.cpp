       ...
       int use_cylsymm )
{
  ...
  gitr_precision tlocal =
  interp2dCombined(x,y,z,nx,nz,tempGridxp,tempGridzp,Tempp, use_cylsymm );

  gitr_precision nlocal =
  interp2dCombined(x,y,z,nx,nz,densGridxp,densGridzp,Densp, use_cylsymm );

  gitr_precision RClocal =
  rateCoeffInterp(charge,tlocal,nlocal,nT_Rates,nD_Rates,rateGrid_Temp, rateGrid_Dens, Rates);
