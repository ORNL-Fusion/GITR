...
5. For Netcdf to work properly, you must have m4. sudo apt install m4

6. You must also have hdf5 installed - sudo apt install libhdf5-dev.

Macos installation:

1. If you do not have Homebrew, get homebrew.

2. brew install hdf5@1.12 <--- this gets the latest version.

3. brew install cmake if you don't have it. Brew install m4 as well? Can't remember.
...
For mac, brew install hdf5@1.12
