...
def analyzeFTrun(pathString):
    ...
    nP, nX, binsX,nY,binsY,nZ, binsZ = analyze_ftridyn_simulations_gitr.plot_sputtered_angular_distributions(pathString+"/"+ffilename,nAgrid)
    np.savetxt(pathString+"/"+"nX.out",nX)
    nP, nX, binsX,nY,binsY,nZ, binsZ = analyze_ftridyn_simulations_gitr.plot_reflected_angular_distributions(pathString+"/"+ffilename,nAgrid)
