...
def iter3dProcessingQ4(nParticles=1200000,totalParticleRate=1.0,path = '',locRmRs=[-0.1,0.02,0.09,0.2],flux_fracs = np.zeros((4,5)),locWidth = 0.02):
	...
	print('thisDist',thisDist) 
        ...
        heatFluxRmRs=[-0.0968,-0.0735,-0.0537,-0.0371,-0.0239,-0.0138,-0.0064,-0.0017,0.0009,0.0044,0.0112,0.0211,0.0341,0.0502,0.0693,0.0918,0.1177,0.1475,0.1814,0.2204,0.2658,0.3142,0.3619,0.4274,0.5442,0.6889,0.8319,0.9599,1.0529,1.1182,1.1682,1.2065,1.2358,1.2629,1.2874,1.3069]
 
        heatFlux=np.multiply(1.0e+06,[0.1106,0.1359,0.2066,0.3500,0.6497,1.0946,1.6078,2.0966,2.8286,3.4223,4.8043,5.2989,4.7962,5.1764,5.0547,4.2162,2.8670,1.9490,1.4311,0.9886,0.7624,0.6522,0.5521,0.3994,0.3265,0.2717,0.2252,0.1756,0.1473,0.0932,0.1185,0.1028,0.1000,0.0798,0.0781,0.0142])
